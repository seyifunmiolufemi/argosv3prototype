...
var CM_CLIENT_META = {
  'Link Imaging':               { status:'active',   modBy:{i:'SK',n:'Sarah K.'}, ago:'2 days ago' },
  'Biddy Murphy':               { status:'active',   modBy:{i:'JR',n:'James R.'}, ago:'5 days ago' },
  "People's Choice Beef Jerky":{ status:'paused',   modBy:{i:'MT',n:'Maria T.'}, ago:'1 week ago' },
  'Simply Authentic LLC':       { status:'active',   modBy:{i:'SK',n:'Sarah K.'}, ago:'3 days ago' },
  'MojoMotoSport.com':          { status:'active',   modBy:{i:'JR',n:'James R.'}, ago:'Yesterday' },
  'Danielhouse Studios Inc':    { status:'inactive', modBy:{i:'MT',n:'Maria T.'}, ago:'2 weeks ago' },
  'ScaffoldMart':               { status:'active',   modBy:{i:'SK',n:'Sarah K.'}, ago:'4 days ago' },
  'BRobinson, LLC':             { status:'active',   modBy:{i:'JR',n:'James R.'}, ago:'6 days ago' },
  'Microscope.com':             { status:'paused',   modBy:{i:'MT',n:'Maria T.'}, ago:'3 weeks ago' },
  'Grovemade':                  { status:'active',   modBy:{i:'SK',n:'Sarah K.'}, ago:'Today' },
  'Dungarees':                  { status:'active',   modBy:{i:'JR',n:'James R.'}, ago:'2 days ago' },
  'Outdoor Research':           { status:'active',   modBy:{i:'MT',n:'Maria T.'}, ago:'3 hours ago' },
  'Chantelle Lingerie Inc':     { status:'active',   modBy:{i:'SK',n:'Sarah K.'}, ago:'1 day ago' },
  'Weaver':                     { status:'active',   modBy:{i:'JR',n:'James R.'}, ago:'5 days ago' },
  'MonkeySports':               { status:'active',   modBy:{i:'MT',n:'Maria T.'}, ago:'4 days ago' },
  'Orchard and Vineyard Supply':{ status:'inactive', modBy:{i:'SK',n:'Sarah K.'}, ago:'1 month ago' },
  'Sunflora Inc':               { status:'active',   modBy:{i:'JR',n:'James R.'}, ago:'3 days ago' },
  'Royal Swimming Pools':       { status:'paused',   modBy:{i:'MT',n:'Maria T.'}, ago:'2 days ago' },
  'My Binding':                 { status:'active',   modBy:{i:'SK',n:'Sarah K.'}, ago:'Today' },
  'eOutdoors':                  { status:'active',   modBy:{i:'JR',n:'James R.'}, ago:'6 hours ago' },
  'Nomadic Vintage Rugs':       { status:'active',   modBy:{i:'MT',n:'Maria T.'}, ago:'8 days ago' }
};

var CM_WEBSITE_DETAIL = {
  '123Inkjets.com':          { domain:'123inkjets.com',          platform:'Shopify',     status:'complete',   modBy:{i:'SK',n:'Sarah K.'}, ago:'2 days ago' },
  '4Inkjets.com':            { domain:'4inkjets.com',            platform:'Shopify',     status:'complete',   modBy:{i:'JR',n:'James R.'}, ago:'5 days ago' },
  'InkCartridges.com':       { domain:'inkcartridges.com',       platform:'Magento',     status:'complete',   modBy:{i:'MT',n:'Maria T.'}, ago:'1 week ago' },
  'LDProducts.com':          { domain:'ldproducts.com',          platform:'Magento',     status:'incomplete', modBy:{i:'SK',n:'Sarah K.'}, ago:'2 weeks ago' },
  'QuickShipToner.com':      { domain:'quickshiptoner.com',      platform:'WooCommerce', status:'incomplete', modBy:{i:'JR',n:'James R.'}, ago:'3 weeks ago' },
  'BiddyMurphy.com':         { domain:'biddymurphy.com',         platform:'Shopify',     status:'complete',   modBy:{i:'MT',n:'Maria T.'}, ago:'5 days ago' },
  'PeoplesChoiceBeefJerky.com':{ domain:'peopleschoicebeefjerky.com', platform:'Shopify', status:'complete',  modBy:{i:'SK',n:'Sarah K.'}, ago:'1 week ago' },
  'SimplySeattle.com':       { domain:'simplyseattle.com',       platform:'Shopify',     status:'complete',   modBy:{i:'JR',n:'James R.'}, ago:'3 days ago' },
  'BurtsPowersports.com':    { domain:'burtspowersports.com',    platform:'BigCommerce', status:'complete',   modBy:{i:'MT',n:'Maria T.'}, ago:'Yesterday' },
  'MojoMotoSport.com':       { domain:'mojomotosport.com',       platform:'BigCommerce', status:'incomplete', modBy:{i:'SK',n:'Sarah K.'}, ago:'4 days ago' },
  'DanielHouseClub.com':     { domain:'danielhouseclub.com',     platform:'Shopify',     status:'incomplete', modBy:{i:'JR',n:'James R.'}, ago:'2 weeks ago' },
  'ScaffoldMart.com':        { domain:'scaffoldmart.com',        platform:'WooCommerce', status:'complete',   modBy:{i:'MT',n:'Maria T.'}, ago:'4 days ago' },
  'Revo.com':                { domain:'revo.com',                platform:'Shopify',     status:'complete',   modBy:{i:'SK',n:'Sarah K.'}, ago:'6 days ago' },
  'Microscope.com':          { domain:'microscope.com',          platform:'Magento',     status:'incomplete', modBy:{i:'JR',n:'James R.'}, ago:'3 weeks ago' },
  'Grovemade.com':           { domain:'grovemade.com',           platform:'Shopify',     status:'complete',   modBy:{i:'MT',n:'Maria T.'}, ago:'Today' },
  'Dungarees.com':           { domain:'dungarees.com',           platform:'Shopify',     status:'complete',   modBy:{i:'SK',n:'Sarah K.'}, ago:'2 days ago' },
  'OutdoorResearch.com':     { domain:'outdoorresearch.com',     platform:'Shopify',     status:'complete',   modBy:{i:'JR',n:'James R.'}, ago:'3 hours ago' },
  'ChantelleUS.com':         { domain:'chantelleusa.com',        platform:'Shopify',     status:'complete',   modBy:{i:'MT',n:'Maria T.'}, ago:'1 day ago' },
  'WeaverEquine.com':        { domain:'weaverequine.com',        platform:'WooCommerce', status:'complete',   modBy:{i:'SK',n:'Sarah K.'}, ago:'5 days ago' },
  'WeaverLeather.com':       { domain:'weaverleather.com',       platform:'WooCommerce', status:'complete',   modBy:{i:'JR',n:'James R.'}, ago:'5 days ago' },
  'WeaverLivestock.com':     { domain:'weaverlivestock.com',     platform:'WooCommerce', status:'incomplete', modBy:{i:'MT',n:'Maria T.'}, ago:'1 week ago' },
  'BaseballMonkey.com':      { domain:'baseballmonkey.com',      platform:'BigCommerce', status:'complete',   modBy:{i:'SK',n:'Sarah K.'}, ago:'4 days ago' },
  'GoalieMonkey.com':        { domain:'goaliemonkey.com',        platform:'BigCommerce', status:'complete',   modBy:{i:'JR',n:'James R.'}, ago:'4 days ago' },
  'HockeyMonkey.com':        { domain:'hockeymonkey.com',        platform:'BigCommerce', status:'complete',   modBy:{i:'MT',n:'Maria T.'}, ago:'4 days ago' },
  'HockeyMonkey.ca':         { domain:'hockeymonkey.ca',         platform:'BigCommerce', status:'complete',   modBy:{i:'SK',n:'Sarah K.'}, ago:'4 days ago' },
  'LacrosseMonkey.com':      { domain:'lacrossemonkey.com',      platform:'BigCommerce', status:'incomplete', modBy:{i:'JR',n:'James R.'}, ago:'1 week ago' },
  'LocalMonkey.com':         { domain:'localmonkey.com',         platform:'BigCommerce', status:'incomplete', modBy:{i:'MT',n:'Maria T.'}, ago:'2 weeks ago' },
  'OrchardValleySupply.com': { domain:'orchardvalleysupply.com', platform:'WooCommerce', status:'incomplete', modBy:{i:'SK',n:'Sarah K.'}, ago:'1 month ago' },
  'Sunmed.com':              { domain:'sunmed.com',              platform:'Shopify',     status:'complete',   modBy:{i:'JR',n:'James R.'}, ago:'3 days ago' },
  'RoyalSwimmingPools.com':  { domain:'royalswimmingpools.com',  platform:'Magento',     status:'incomplete', modBy:{i:'MT',n:'Maria T.'}, ago:'2 days ago' },
  'MyBinding.com':           { domain:'mybinding.com',           platform:'Magento',     status:'complete',   modBy:{i:'SK',n:'Sarah K.'}, ago:'Today' },
  'IslandBeachGear.com':     { domain:'islandbeachgear.com',     platform:'Shopify',     status:'complete',   modBy:{i:'JR',n:'James R.'}, ago:'6 hours ago' },
  'TackleDirect.com':        { domain:'tackledirect.com',        platform:'Magento',     status:'complete',   modBy:{i:'MT',n:'Maria T.'}, ago:'6 hours ago' },
  'NomadicVintageRugs.com':  { domain:'nomadicvintagerugs.com',  platform:'Shopify',     status:'complete',   modBy:{i:'SK',n:'Sarah K.'}, ago:'8 days ago' }
};
...
var CM_OPTS = {
  ...
  csm:      ['Sarah K.', 'James R.', 'Maria T.', 'Alex P.', 'Chris L.'],
  sem:      ['James R.', 'Alex P.', 'Chris L.', 'Sarah K.', 'Maria T.'],
  seo:      ['Maria T.', 'Chris L.', 'Alex P.', 'James R.', 'Sarah K.'],
